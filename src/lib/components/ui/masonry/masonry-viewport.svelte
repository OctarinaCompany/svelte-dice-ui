<script lang="ts" module>
	 ...
	 * the `React.Children` inspection that items now do for themselves (research R-01/R-03).
	 *
	...
	export type MasonryViewportProps = {
		/** Rendered instead of the whole positioned list until the root has mounted (research R-08). */
		fallback?: Snippet;
		children?: Snippet;
	};
</script>
