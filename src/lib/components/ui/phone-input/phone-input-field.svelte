...
<script lang="ts">
	 ...
	 * without a generation counter a rejected character would linger in the DOM (research R-09).
	 */
...
<!--
	...
	order exactly (research R-12). `value` is one-way — never `bind:value`, which would make a second
