...
>
	{#if columnFilterValue}
		<!--
			...
			dims. `ps-2.5` puts the X exactly where the resting plus icon sits, and the `pe-1.5` and
			trigger `ps-1.5` give the rule below the same 6px flanks as the label↔badges one.
		-->
		<button
			type="button"
