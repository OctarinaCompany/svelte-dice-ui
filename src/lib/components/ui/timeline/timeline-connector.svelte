	...
	export const timelineConnectorVariants = tv({
		...
		compoundVariants: [
			...
			},
			{
				...
				class:
					'top-2 -end-[calc(var(--timeline-connector-thickness)/2)] h-full w-[var(--timeline-connector-thickness)]'
			},
			{
				orientation: 'vertical',
				variant: 'alternate',
				...
				class:
					'top-2 -start-[calc(var(--timeline-connector-thickness)/2)] h-full w-[var(--timeline-connector-thickness)]'
			},
			{
				orientation: 'horizontal',
				variant: 'alternate',
				class:
					'top-[calc(var(--timeline-dot-size)/2-var(--timeline-connector-thickness)/2)] start-3 row-start-2 h-[var(--timeline-connector-thickness)] w-[calc(100%+0.5rem)]'
			}
		],
		defaultVariants: {
			isCompleted: false,
