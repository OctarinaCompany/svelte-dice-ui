...
<script lang="ts">
	 ...
	 * (`mention-highlighter.tsx:58-101`) as one effect whose teardown stops all four.
	 */
	$effect(() => {
	...
	/**
	 * Upstream `onSegmentsRender` (`mention-highlighter.tsx:132-173`). The spans are walked in text
