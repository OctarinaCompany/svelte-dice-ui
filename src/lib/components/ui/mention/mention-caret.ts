 ...
 * (upstream `mention-input.tsx:25-44`).
 */
...
/**
 * The field's line height (upstream `mention-input.tsx:46-49`).
 *
 ...
 * (upstream `mention-input.tsx:51-111`).
 *
 ...
 * the field scrolls or resizes (upstream `mention-input.tsx:113-134`).
 */
 ...
 * (upstream `mention-input.tsx:136-264`).
 *
 ...
 * (upstream `mention-root.tsx:309-321`).
 */
 ...
 * (upstream `mention-root.tsx:337-367`).
 *
...
/**
 * Move every span that sits after a plain text edit (upstream `mention-input.tsx:276-293`).
