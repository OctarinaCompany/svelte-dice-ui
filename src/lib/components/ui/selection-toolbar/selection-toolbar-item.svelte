...
<script lang="ts">
	 ...
	 * routes it down the `click` branch (FR-010, research R-06). A plain `let`, never rendered.
	 */
	...
	function onpointerdown(event: PointerEvent) {
		...
		// on press; doing it for touch would break the platform's own selection handles (FR-014).
