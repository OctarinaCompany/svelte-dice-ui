<script lang="ts" module>
	...
	import {
		...
		isValidMaxNumber,
		isValidValueNumber
	} from '../circular-progress/circular-progress.svelte.js';
	import {
		DEFAULT_END_ANGLE,
		DEFAULT_GAUGE_SIZE,
...
<script lang="ts">
	...
	// of the test surface (research.md R-16). `untrack` documents that this is a deliberate one-time
	...
	const rootAttrs = $derived({
		role: 'meter',
		'aria-describedby': state.valueText !== undefined ? valueTextId : undefined,
