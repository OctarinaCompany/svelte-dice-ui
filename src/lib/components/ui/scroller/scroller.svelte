<script lang="ts" module>
	 ...
	 * and no token exists for (or belongs in) a mask (research R-10). The mask attributes are matched
...
<script lang="ts">
	...
	import { observeScrollPosition } from './scroll-position.svelte.js';
	 ...
	 * the navigation buttons fully functional (research R-05). The reference is deliberately stable,
	 * so re-deriving the attribute object on every scroll never re-subscribes.
	 */
