 ...
 * rendered markup — which is what lets `child`-mode consumers and SSR see them too (research R-01).
 */
export class ScrollerState {
	...
	// stay physical while which logical end they represent flips under RTL (divergence D-01, R-04).
	 ...
	 * scrollHeight`). Reproduced verbatim — see research R-03.
	 */
