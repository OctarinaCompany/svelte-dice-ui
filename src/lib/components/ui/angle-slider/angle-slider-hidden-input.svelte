<script lang="ts" module>
	...
	/**
	 * Port of upstream `docs/registry/bases/radix/components/visually-hidden-input.tsx`.
	 *
...
<input
	...
	{...restProps}
	style="{style ??
		''}{sizeStyle}border:0;clip:rect(0 0 0 0);clip-path:inset(50%);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px;"
/>
