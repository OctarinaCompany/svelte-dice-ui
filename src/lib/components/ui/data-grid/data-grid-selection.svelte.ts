 ...
 * anchor/edge semantics, Ctrl-click toggling and extend-to-extremity (plan.md Principle IV item 2).
...
export class DataGridSelectionState {
	 ...
	 *
	 * With `enableSingleCellSelection` the rectangle collapses to `end` alone (FR-012a).
	 */
	...
	/** Select every cell of one column. Requires `enableColumnSelection` (FR-012a). */
