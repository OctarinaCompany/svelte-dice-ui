...
/** table-core's `defaultColumn.minSize` for this port. */
export const MIN_COLUMN_SIZE = 60;

/** table-core's `defaultColumn.maxSize` for this port. */
export const MAX_COLUMN_SIZE = 800;

/** How many pixels one arrow key adds to or removes from a column's width (FR-036, SC-005). */
 ...
 * bare domain gets an `http://` prefix.
 */
