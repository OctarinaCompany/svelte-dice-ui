 ...
 * and therefore fully unit-testable under jsdom, where every rect is zero (plan.md Principle IV
 * item 1). `@tanstack/react-virtual` is replaced rather than added as a dependency for exactly
 * that reason.
 */
