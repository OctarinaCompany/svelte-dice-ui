<script lang="ts" module>
	...
	> & {
		 ...
		 * always receives the state — the render-prop translation in `CLAUDE.md` §10. When omitted,
		 * the default content is a check icon for a completed step and the 1-based step position
		 * otherwise.
		 *
		 * ```svelte
