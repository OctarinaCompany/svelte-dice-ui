<script lang="ts">
	...
	// Default — mirrors pending-demo.tsx
	...
	// Wrapper Component — mirrors pending-wrapper-demo.tsx
	...
	// Form with Pending State — mirrors pending-form-demo.tsx
	...
	// Navigation Links — mirrors pending-link-demo.tsx
	...
	// Toggle Switches — mirrors pending-switch-demo.tsx
...
<svelte:head>
	<title>Pending — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Pending</h1>
		<p class="text-muted-foreground">
			A utility that disables interactions, keeps keyboard focus and wires the correct ARIA state
			for buttons, forms, links, switches and any interactive element while it is pending.
		</p>
	</div>

	<ComponentPreview title="Default" description="Mirrors pending-demo.tsx.">
	...
	<ComponentPreview title="Wrapper Component" description="Mirrors pending-wrapper-demo.tsx.">
		<div class="flex flex-col items-center gap-4">
	...
	<ComponentPreview title="Form with Pending State" description="Mirrors pending-form-demo.tsx.">
	...
	<ComponentPreview title="Navigation Links" description="Mirrors pending-link-demo.tsx.">
		<div class="flex items-center justify-center">
			<Pending.Root isPending={isNavigating}>
				{#snippet child({ props })}
					<a
						href={resolve('/docs/components/pending')}
						onclick={onNavigate}
	...
	<ComponentPreview title="Toggle Switches" description="Mirrors pending-switch-demo.tsx.">
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">usePending options</h3>
			<Table.Root>
				<Table.Header>
					<Table.Row>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">usePending return</h3>
			<Table.Root>
				<Table.Header>
					<Table.Row>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">&lt;Pending.Root&gt;</h3>
			<Table.Root>
				<Table.Header>
					<Table.Row>
						<Table.Head>Prop</Table.Head>
