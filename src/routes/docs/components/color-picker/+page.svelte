...
<dl>
	...
	const contextMembers: StateRow[] = [
		...
		},
		{
			...
			type: 'string',
			description: '#rrggbb — what the hidden input submits — and the color in the active notation.'
		},
...
<svelte:head>
	<title>Color Picker — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Color Picker</h1>
	...
	<ComponentPreview title="Default" description="Mirrors color-picker-demo.tsx.">
	...
	<ComponentPreview
		title="Inline"
		description="Mirrors color-picker-inline-demo.tsx — the inline prop drops the popover entirely."
	>
	...
	<ComponentPreview title="Controlled" description="Mirrors color-picker-controlled-demo.tsx.">
		<div class="flex flex-col gap-4">
			<div class="flex items-center gap-3">
				<ColorPicker.Root
	...
	<ComponentPreview
		title="Form"
		description="Adapts color-picker-form-demo.tsx to a native form — this repo ships neither react-hook-form nor zod, so the three named pickers submit through their hidden inputs and are hex-validated on submit."
	>
		<form
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">getColorPickerContext</h3>
