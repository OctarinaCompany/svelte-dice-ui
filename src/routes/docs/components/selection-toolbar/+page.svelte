<script lang="ts">
	...
	// Default — mirrors selection-toolbar-demo.tsx
	let editorElement = $state<HTMLDivElement | null>(null);
	let lastAction = $state('');

	// With selection info — mirrors selection-toolbar-info-demo.tsx
	...
	function onLink() {
		...
		// preview, so the demo links to a fixed placeholder instead (spec.md Assumptions).
...
<svelte:head>
	<title>Selection Toolbar — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Selection Toolbar</h1>
	...
	<ComponentPreview
		title="Default"
		description="Mirrors selection-toolbar-demo.tsx. Select any text inside the editable card to raise the toolbar."
	>
		<div class="flex w-full flex-col gap-4">
			...
			<!-- Outside the tracked container on purpose: selecting here raises nothing (FR-004). -->
	...
	<ComponentPreview
		...
		description="Mirrors selection-toolbar-info-demo.tsx. `onSelectionChange` drives a live word and character count."
	>
		<div class="flex w-full flex-col gap-4">
			<div
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">SelectionToolbar.Root</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">SelectionToolbar.Item</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">SelectionToolbar.Separator</h3>
			<p class="text-sm text-muted-foreground">
