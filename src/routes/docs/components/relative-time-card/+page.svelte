<script lang="ts">
	...
	const dataAttributes = [
		...
		{ attribute: '[data-variant]', part: 'trigger', values: 'default | muted | ghost' },
		{
...
<svelte:head>
	<title>Relative Time Card — svelte-dice-ui</title>
</svelte:head>
...
<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Relative Time Card</h1>
		<p class="text-muted-foreground">
			A hover card that displays relative time relative to local time with timezone information.
		</p>
	</div>

	<ComponentPreview title="Default" description="Mirrors relative-time-card-demo.tsx.">
	...
	<ComponentPreview title="Basic" description="Mirrors relative-time-card-basic-demo.tsx.">
	...
	<ComponentPreview title="Timezones" description="Mirrors relative-time-card-timezones-demo.tsx.">
		<div class="flex flex-col gap-4">
			<RelativeTimeCard.Root
				date={now}
				timezones={[
	...
	<ComponentPreview
		title="Variants"
		description="Mirrors relative-time-card-variants-demo.tsx. Upstream’s palette colours map to the semantic status tokens."
	>
		<div class="flex flex-col gap-6">
			<div class="flex flex-col gap-2">
				...
				<div class="flex items-center gap-4">
					...
					<RelativeTimeCard.Root date={now} variant="ghost" />
				</div>
			</div>
			<div class="flex flex-col gap-2">
	...
	<ComponentPreview
		title="Controlled"
		description="`bind:open` keeps the parent authoritative; `onOpenChange` fires on every transition."
	>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">RelativeTimeCard</h3>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">RelativeTimeCard.Timezone</h3>
			<p class="text-sm text-muted-foreground">
			...
			<Table.Root>
				...
				<Table.Body>
					<Table.Row>
						...
						<Table.Cell>
							Focusing the trigger opens the card after <code>openDelay</code>; tabbing away closes
							it after <code>closeDelay</code>.
						</Table.Cell>
					</Table.Row>
					<Table.Row>
