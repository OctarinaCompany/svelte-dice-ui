<script lang="ts">
	...
	const rootProps = [
		...
		},
		{
			...
			type: 'boolean',
			default: 'false',
			description: 'Adds aria-disabled and data-disabled, and applies the disabled variant classes.'
		},
		{
			prop: 'class',
			type: 'ClassValue',
...
<svelte:head>
	<title>Color Swatch — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Color Swatch</h1>
	...
	<ComponentPreview title="Default" description="Mirrors color-swatch-demo.tsx.">
	...
	<ComponentPreview title="Sizes" description="Mirrors color-swatch-sizes-demo.tsx.">
		<div class="flex flex-col gap-6">
			<div class="flex flex-col gap-2">
	...
	<ComponentPreview title="Transparency" description="Mirrors color-swatch-transparency-demo.tsx.">
		<div class="flex flex-col gap-6">
			<div class="flex flex-col gap-2">
	...
	<ComponentPreview
		title="Usage"
		description="The MDX Usage snippet, plus the empty/invalid edge cases."
	>
		<div class="flex flex-col gap-6">
			<div class="flex items-center gap-3">
				<ColorSwatch.Root color="#3b82f6" />
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ColorSwatch</h3>
