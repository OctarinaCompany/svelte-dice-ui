 ...
 *
 * A rune port of upstream's `useShiftMultiSelect`, which lives in the demo file rather than in the
 * component (`checkbox-group-multi-selection-demo.tsx:56-140`) — the checkbox group has no
 * shift-select prop and gains none here (research R-13).
 *
