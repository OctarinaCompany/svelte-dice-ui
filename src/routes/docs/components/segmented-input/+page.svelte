...
<svelte:head>
	<title>Segmented Input — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Segmented Input</h1>
	...
	<ComponentPreview
		title="Default"
		description="Mirrors segmented-input-demo.tsx. Arrow keys cross a segment boundary once the caret sits at that edge, and pasting “Ada Byron King” fills all three fields at once."
	>
		<div class="flex w-full max-w-sm flex-col gap-2">
			...
			<SegmentedInput.Root class="w-full" aria-labelledby="segmented-input-name-label">
				<SegmentedInput.Item bind:value={name.first} placeholder="First" aria-label="First name" />
				<SegmentedInput.Item
					bind:value={name.second}
					placeholder="Second"
					aria-label="Middle name"
				/>
				<SegmentedInput.Item bind:value={name.third} placeholder="Third" aria-label="Last name" />
			</SegmentedInput.Root>
		</div>
	</ComponentPreview>
	...
	<ComponentPreview
		title="Form Input"
		description="Mirrors segmented-input-form-demo.tsx. Each segment declares its own maxlength, so pasting “5551234567” into the area code splits it across the two remaining fields."
	>
	...
	<ComponentPreview
		...
		description="Mirrors segmented-input-rgb-demo.tsx. Each channel clamps itself to 0–255, and a pasted “255, 128, 0” lands one value per channel."
	>
		<div class="flex flex-col gap-2">
			<span id="segmented-input-rgb-label" class="text-sm leading-none font-medium">RGB Color</span>
	...
	<ComponentPreview
		...
		description="Mirrors segmented-input-vertical-demo.tsx. In a vertical group the up and down arrows move between fields and the horizontal ones stay with the caret."
	>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">SegmentedInput.Root</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">SegmentedInput.Item</h3>
			<p class="text-sm text-muted-foreground">
