<script lang="ts">
	...
	const dataAttributes = [
		...
		{ part: 'Marquee.Edge', attribute: '[data-side]', value: '"left" | "right" | "top" | "bottom"' }
	];
...
<svelte:head>
	<title>Marquee — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Marquee</h1>
		<p class="text-muted-foreground">
			An animated scrolling component that continuously moves content horizontally or vertically,
			with hover and keyboard pausing, RTL mirroring and reduced-motion support.
		</p>
	</div>

	<ComponentPreview title="Default" description="Mirrors marquee-demo.tsx.">
					...
					<Marquee.Item>
						{#snippet child({ props })}
							...
							>
								...
								<span class="line-clamp-2 text-sm text-muted-foreground">{trick.description}</span>
							</div>
						{/snippet}
					</Marquee.Item>
				{/each}
	...
	<ComponentPreview title="Logo Showcase" description="Mirrors marquee-logo-demo.tsx.">
	...
	<ComponentPreview
		...
		description="Mirrors marquee-vertical-demo.tsx."
		class="h-[400px]"
	>
	...
	<ComponentPreview
		title="With RTL"
		description="Mirrors marquee-rtl-demo.tsx — once with an explicit dir prop, once resolving the ambient direction from a DirectionProvider."
	>
					...
					{#each features as feature (feature.title)}
						<Marquee.Item>
							{#snippet child({ props })}
								...
								>
									<div class="text-sm leading-tight font-medium sm:text-base">{feature.title}</div>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">Marquee (Root)</h3>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">Marquee.Content</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">Marquee.Item</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">Marquee.Edge</h3>
			<p class="text-sm text-muted-foreground">
			...
			<Table.Root>
				...
				<Table.Body>
					...
					<Table.Row>
						...
						<Table.Cell>
							Moves focus onto the marquee when <code>pauseOnKeyboard</code> is enabled, which also
							pauses it while <code>pauseOnHover</code> is set.
						</Table.Cell>
					</Table.Row>
				</Table.Body>
			</Table.Root>
