...
<svelte:head>
	<title>Angle Slider — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Angle Slider</h1>
		<p class="text-muted-foreground">
			An interactive circular slider for selecting angles with support for single values and ranges.
		</p>
	</div>

	<ComponentPreview title="Default" description="Mirrors angle-slider-demo.tsx.">
	...
	<ComponentPreview
		title="Controlled"
		description="Mirrors angle-slider-controlled-demo.tsx. Reset and Randomize animate the dial with a plain requestAnimationFrame ramp."
	>
	...
	<ComponentPreview
		title="Range"
		description="Mirrors angle-slider-range-demo.tsx. Two thumbs kept at least four steps apart."
	>
		<div class="flex flex-col items-center gap-4">
			<AngleSlider.Root
				bind:value={range}
	...
	<ComponentPreview
		title="Themes"
		description="Mirrors angle-slider-themes-demo.tsx, with every upstream palette colour mapped onto a semantic token."
	>
	...
	<ComponentPreview
		title="Form"
		description="Mirrors angle-slider-form-demo.tsx. Each dial carries a visually hidden input, so the whole form submits natively."
	>
		<form class="flex flex-col items-center gap-6" onsubmit={onSubmit}>
			<div class="flex flex-wrap items-center justify-center gap-8">
				...
				<div class="flex flex-col items-center gap-2">
					<AngleSlider.Root name="arc" bind:value={formArc} min={0} max={360} step={5} size={48}>
						<AngleSlider.Track>
							<AngleSlider.Range />
						</AngleSlider.Track>
						<AngleSlider.Thumb index={0} />
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">AngleSlider.Root</h3>
