<script lang="ts">
	...
	// Default — mirrors action-bar-demo.tsx
	...
	// Position — mirrors action-bar-position-demo.tsx
...
<svelte:head>
	<title>Action Bar — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Action Bar</h1>
	...
	<ComponentPreview
		title="Default"
		description="Mirrors action-bar-demo.tsx. Tick a task to raise the bar; it closes itself when the selection clears."
	>
	...
	<ComponentPreview
		title="Position"
		description="Mirrors action-bar-position-demo.tsx. `side` and `align` dock the bar to a viewport edge."
	>
		<div class="flex flex-col gap-4">
			...
			<div class="flex items-center gap-2">
				...
				>
					<Select.Trigger id="action-bar-align" class="w-28">{ALIGN_LABELS[align]}</Select.Trigger>
					<Select.Content>
						<Select.Group>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Root</h3>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Selection</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Group</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Item</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Close</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">ActionBar.Separator</h3>
			<p class="text-sm text-muted-foreground">
