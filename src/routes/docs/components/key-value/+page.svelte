<script lang="ts">
	...
	// this registry, so the same rules live in plain runes here (spec Assumptions, divergence D-12).
	...
	const rootProps: PropRow[] = [
		...
		},
		{
			...
			type: 'boolean',
			default: 'true',
			description: 'Whether multi-line clipboard text in a key field expands into one row per line.'
		},
		{
			prop: 'trim',
			type: 'boolean',
	...
	const keyboard = [
		...
		{
			keys: 'Ctrl + V',
			description: 'Pastes. Multi-line clipboard text in a key field expands into one row per line.'
		}
	];
</script>

<svelte:head>
	<title>Key Value — svelte-dice-ui</title>
</svelte:head>
...
<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Key Value</h1>
	...
	<ComponentPreview
		title="Default"
		description="Mirrors key-value-demo.tsx. Tab into a field to edit it in place; Add appends a row and focuses its key, Remove takes one away and moves focus to a neighbour."
	>
	...
	<ComponentPreview
		...
		description="Mirrors key-value-paste-demo.tsx. Paste a multi-line block into a key field and it expands into one row per line."
	>
...
PORT=3000</pre>
	...
	<ComponentPreview
		...
		description="Mirrors key-value-validation-demo.tsx. Keys must be uppercase with underscores, values of a *KEY* row must be at least ten characters, and duplicate non-empty keys are flagged."
	>
		<KeyValue.Root
	...
	<ComponentPreview
		title="With Form"
		description="Mirrors key-value-form-demo.tsx. A native <form> with Field and rune state stands in for react-hook-form and zod, which have no Svelte analogue here."
	>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.Root</h3>
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.List</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.Item</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.KeyInput</h3>
			<p class="text-sm text-muted-foreground">
				The key field, composed from <a
					href={resolve('/docs/components/editable')}
					class="underline">Editable</a
				>
				so it opens on focus and closes on blur. <code>class</code> lands on the field wrapper; every
				other attribute lands on the control.
			</p>
			{@render propsTable(keyInputProps)}
		</div>

		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.ValueInput</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.Remove</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.Add</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">KeyValue.Error</h3>
			<p class="text-sm text-muted-foreground">
