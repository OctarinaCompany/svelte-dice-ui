...
<article class="flex flex-col gap-10">
	...
	<ComponentPreview
		title="Editable"
		description="Mirrors tags-input-editable-demo.tsx. Double-click a tag — or highlight it and press Enter — to edit it in place; pasting a comma-separated list adds every value at once, and the clear button is rendered as a Button through the child snippet."
	>
	...
	<ComponentPreview
		...
		description="Mirrors tags-input-validation-demo.tsx. Add up to 6 tricks with at least 3 characters, excluding “ollie”; every rejection raises a toast."
	>
		<TagsInput.Root
	...
	<ComponentPreview
		title="With Sortable"
		description="Mirrors tags-input-sortable-demo.tsx. Upstream composes TagsInput with its Sortable component, which is built on @dnd-kit and has no counterpart here yet, so this page owns the reordering: drag a tag onto another one, or highlight a tag and press Alt+ArrowLeft / Alt+ArrowRight."
	>
		<TagsInput.Root
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.Root</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.Label</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.Input</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.Item</h3>
			<p class="text-sm text-muted-foreground">One rendered tag.</p>
			{@render propsTable(itemProps)}
		</div>

		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.ItemText</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.ItemDelete</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">TagsInput.Clear</h3>
			<p class="text-sm text-muted-foreground">
