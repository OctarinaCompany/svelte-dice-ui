<script lang="ts">
	...
	const tagClass =
		'**:data-tag:rounded **:data-tag:bg-info/15 **:data-tag:py-px **:data-tag:text-info';
...
<svelte:head>
	<title>Mention — svelte-dice-ui</title>
</svelte:head>

<article class="flex flex-col gap-10">
	<div class="flex flex-col gap-2">
		<h1 class="text-3xl font-semibold tracking-tight">Mention</h1>
	...
	<ComponentPreview
		title="Default"
		description="Mirrors mention-demo.tsx. Type @ to mention someone; the tags are styled through the data-tag attribute on the root."
	>
	...
	<ComponentPreview
		...
		description="Mirrors mention-custom-trigger-demo.tsx. The popup opens on # instead of @."
	>
	...
	<ComponentPreview
		...
		description="Mirrors mention-custom-filter-demo.tsx. A controlled slash-command palette whose onFilter keeps only the commands starting with the typed term."
	>
	...
	<section class="flex flex-col gap-6">
		...
		<div class="flex flex-col gap-3">
			<h3 class="text-lg font-medium">Mention.Root</h3>
			<p class="text-sm text-muted-foreground">
		...
		<div class="flex flex-col gap-3">
			...
			<p class="text-sm text-muted-foreground">
				The popup also exposes <code>--dice-transform-origin</code>,
				<code>--dice-anchor-width</code>, <code>--dice-anchor-height</code>,
